...
export const trips = {
  generate: (body: {
    ...
    request<{ _id: string; destination: string; durationDays: number; preferences: { interests: string[]; budget: string }; days: import("@/types").Day[]; isPublic: boolean; createdAt: string }>("/trips/generate", {
      method: "POST",
      body: JSON.stringify(body),
    }),
