            ...
            <>
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-dark text-sm font-medium text-brand-muted hover:text-brand-gold transition-colors"
                >
